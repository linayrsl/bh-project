      ...
      <div className="family-tree-thanks-page-container">
        ...
        <div className="family-tree-thanks-body">
          <div className="text-first-part">
            <p>תודה רבה!</p>
            <p>העץ נשמר במאגר עצי המשפחה המאובטח של מוזיאון העם היהודי. ברגעים אלו נשלח אליכם קובץ מייל עם הפרטים.</p>
            <p>
              אתם מוזמנים לבקר במוזיאון העם היהודי בבית התפוצות ולהמשיך ללמוד,
              לחקור ולהיות חלק מהסיפור.
            </p>
          ...
          <div className="page-content-container information">
            ...
            <div className="information-bar-body">
              ...
              <div className="information-bar">
                <div className="line-style"> אודות פרויקט זה </div>
                <div className="text-line4">
                  ...
                  ארגון <a href={"https://she-codes.org/"} target={"_blank"}>she codes</a>; ששם לו למטרה לקדם נשים במגזר ההייטק, ונוהל
